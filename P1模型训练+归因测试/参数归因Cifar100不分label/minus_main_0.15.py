...
all_totals = list()
all_totals.append(attack(train_dataloader_all, all_param_names, load_cifar100_resnet50,norm=True, alpha=0.00001,num_steps=2,op="minus"))

# %%
pkl.dump(all_totals, open("weights/minus_totals_0.15.pkl", "wb"))
# %%
thre = 0.15
